...
// 16 创建收货地址
export const addAddress= (address_info,address_id) => ajax(BASE_URL + '/api/add_address_info', {address_info,address_id}, 'POST');

// 15 请求地址的数据
export const getAddress = () => ajax(BASE_URL + '/api/get_address_info');

// 17 创建收货地址
export const addressDefault= (address_id) => ajax(BASE_URL + '/api/address_default', {address_id}, 'POST');

// 17 删除收货地址
export const delAddress= (address_id) => ajax(BASE_URL + '/api/del_address', {address_id}, 'POST');

// 11 请求订单管理的数据
export const getOrderManage = (params) => ajax(BASE_URL + '/api/order_manage_info', params);
